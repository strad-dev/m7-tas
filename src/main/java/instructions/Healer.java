...
//		}, 70);
//		Utils.scheduleTask(() -> Actions.rightClickOld(healer), 71);
//		Utils.scheduleTask(() -> Actions.salvation(healer), 75);
//		Utils.scheduleTask(() -> Actions.rightClickOld(healer), 76);
//		Utils.scheduleTask(() -> {
...
//		Utils.scheduleTask(() -> Actions.rightClickOld(healer), 90);
//		Utils.scheduleTask(() -> Actions.salvation(healer), 91);
//		Utils.scheduleTask(() -> Actions.rightClickOld(healer), 95);
...
//			Actions.setHotbarSlot(healer, 4);
//		}, 151);
//		Utils.scheduleTask(() -> Actions.rightClickOld(healer), 152);
//		Utils.scheduleTask(() -> Actions.salvation(healer), 156);
//		Utils.scheduleTask(() -> Actions.rightClickOld(healer), 157);
//		Utils.scheduleTask(() -> {
