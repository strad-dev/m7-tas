...
public class Berserk {
	...
	private static void clear(boolean doContinue) {
		...
		Utils.scheduleTask(() -> Actions.AOTV(berserk, new Location(world, -22.5, 69, -223.5)), 2);
		Utils.scheduleTask(() -> {
			Actions.turnHead(berserk, -126.9f, 12.2f);
			Actions.setFakePlayerHotbarSlot(berserk, 5);
		}, 3);
		Utils.scheduleTask(() -> Actions.stonk(berserk, world.getBlockAt(-22, 70, -224)), 4);
		Utils.scheduleTask(() -> Actions.stonk(berserk, world.getBlockAt(-22, 70, -225)), 5);
		Utils.scheduleTask(() -> Actions.stonk(berserk, world.getBlockAt(-21, 70, -225)), 6);
		Utils.scheduleTask(() -> {
		...
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -24.5, 69, -184.5)), 9);
		...
		Utils.scheduleTask(() -> Actions.AOTV(berserk, new Location(world, -20.5, 69, -182.5)), 11);
		Utils.scheduleTask(() -> Actions.turnHead(berserk, -138.5f, 90), 12);
		Utils.scheduleTask(() -> Actions.AOTV(berserk, new Location(world, -20.5, 59, -182.5)), 13);
		...
		Utils.scheduleTask(() -> Actions.AOTV(berserk, new Location(world, -20.5, 72, -182.5)), 17);
		Utils.scheduleTask(() -> Actions.turnHead(berserk, 81.0f, -67.7f), 18);
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -23.5, 82, -181.5)), 19);
		Utils.scheduleTask(() -> Actions.turnHead(berserk, 57.5f, 9.3f), 20);
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -31.5, 82, -176.5)), 21);
		Utils.scheduleTask(() -> {
			Actions.turnHead(berserk, 60.1f, 38.9f);
			Actions.setFakePlayerHotbarSlot(berserk, 0);
		}, 22);
		Utils.scheduleTask(() -> {
			Actions.witherImpact(berserk, new Location(world, -35.5, 80, -174.5));
		...
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -38.5, 80, -183.5)), 25);
		Utils.scheduleTask(() -> Actions.turnHead(berserk, 108.8f, 5.1f), 26);
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -55.5, 80, -189.5)), 27);
		Utils.scheduleTask(() -> Actions.turnHead(berserk, -144.1f, 3.7f), 28);
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -45.5, 81, -203.5)), 29);
		Utils.scheduleTask(() -> Actions.turnHead(berserk, -168.7f, 9.2f), 30);
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -44.5, 81, -213.5)), 31);
		Utils.scheduleTask(() -> {
			Actions.turnHead(berserk, 146.5f, -2.3f);
			Actions.setFakePlayerHotbarSlot(berserk, 3);
		}, 32);
		Utils.scheduleTask(() -> Actions.superboom(berserk, -47, 81, -217, -46, 84, -216), 33);
		Utils.scheduleTask(() -> Actions.setFakePlayerHotbarSlot(berserk, 1), 34);
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -54.5, 83.5, -228.5)), 35);
		...
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -54.5, 86, -219.5)), 39);
		Utils.scheduleTask(() -> {
			Actions.turnHead(berserk, 0f, 45f);
			Actions.setFakePlayerHotbarSlot(berserk, 5);
		}, 40);
		Utils.scheduleTask(() -> {
			Actions.stonk(berserk, world.getBlockAt(-55, 87, -219));
			Actions.move(berserk, new Vector(0, 0, 1.12242), 3);
		}, 41);
		Utils.scheduleTask(() -> Actions.stonk(berserk, world.getBlockAt(-55, 86, -219)), 42);
		Utils.scheduleTask(() -> {
			Actions.turnHead(berserk, 14.8f, 45f);
			Actions.setFakePlayerHotbarSlot(berserk, 1);
		}, 43);
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -59.5, 69, -198.5)), 44);
		Utils.scheduleTask(() -> Actions.turnHead(berserk, 36f, 16f), 45);
		Utils.scheduleTask(() -> Actions.AOTV(berserk, new Location(world, -62.5, 69, -194.5)), 46);
		Utils.scheduleTask(() -> Actions.setFakePlayerHotbarSlot(berserk, 5), 47);
		Utils.scheduleTask(() -> Actions.stonk(berserk, world.getBlockAt(-64, 70, -194)), 48);
		Utils.scheduleTask(() -> {
			Actions.swingHand(berserk);
		...
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -56.5, 69, -194.5)), 51);
		Utils.scheduleTask(() -> Actions.turnHead(berserk, 9.3f, 5.2f), 52);
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -58.5, 69, -176.5)), 53);
		Utils.scheduleTask(() -> {
			Actions.turnHead(berserk, 75f, 15.9f);
			Actions.setFakePlayerHotbarSlot(berserk, 3);
		}, 54);
		Utils.scheduleTask(() -> Actions.superboom(berserk, -61, 69, -177, -62, 73, -174), 55);
		Utils.scheduleTask(() -> Actions.setFakePlayerHotbarSlot(berserk, 1), 56);
		Utils.scheduleTask(() -> Actions.AOTV(berserk, new Location(world, -64.5, 69.0625, -175.5)), 57);
		Utils.scheduleTask(() -> {
			Actions.swingHand(berserk);
		...
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -54.5, 71.5, -176.5)), 60);
		Utils.scheduleTask(() -> Actions.turnHead(berserk, 165.2f, 6.8f), 61);
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -64.5, 69, -215.5)), 62);
		Utils.scheduleTask(() -> Actions.turnHead(berserk, 90f, 4.4f), 63);
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -86.5, 69, -215.5)), 64);
		...
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -93.5, 70.5, -210.5)), 73);
		Utils.scheduleTask(() -> Actions.turnHead(berserk, 64.3f, 34.8f), 74);
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -101.5, 66, -206.5)), 75);
		...
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -93.5, 63, -211.5)), 79);
		Utils.scheduleTask(() -> Actions.turnHead(berserk, -33.2f, 68.7f), 80);
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -96.5, 50, -206.5)), 81);
		Utils.scheduleTask(() -> {
			Actions.turnHead(berserk, -96.4f, 17.5f);
			Actions.setFakePlayerHotbarSlot(berserk, 3);
		}, 82);
		Utils.scheduleTask(() -> Actions.superboom(berserk, -94, 50, -207, -93, 53, -209), 83);
		Utils.scheduleTask(() -> Actions.setFakePlayerHotbarSlot(berserk, 1), 84);
		Utils.scheduleTask(() -> Actions.AOTV(berserk, new Location(world, -90.5, 50, -207.5)), 85);
		Utils.scheduleTask(() -> {
			Actions.swingHand(berserk);
		...
		Utils.scheduleTask(() -> Actions.AOTV(berserk, new Location(world, -95.5, 50, -205.5)), 88);
		Utils.scheduleTask(() -> Actions.turnHead(berserk, -2.6f, -18.9f), 89);
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -94.5, 59, -184.5)), 90);
		Utils.scheduleTask(() -> Actions.turnHead(berserk, 1.6f, -2.4f), 91);
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -95.5, 63, -146.5)), 92);
		Utils.scheduleTask(() -> Actions.turnHead(berserk, -106.2f, 12.2f), 93);
		Utils.scheduleTask(() -> Actions.AOTV(berserk, new Location(world, -92.5, 64, -147.5)), 94);
		...
		Utils.scheduleTask(() -> Actions.AOTV(berserk, new Location(world, -95.5, 63, -147.5)), 98);
		Utils.scheduleTask(() -> Actions.turnHead(berserk, -85.1f, 87.4f), 99);
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -94.5, 50, -147.5)), 100);
		Utils.scheduleTask(() -> Actions.turnHead(berserk, 0f, 24.1f), 101);
		Utils.scheduleTask(() -> Actions.AOTV(berserk, new Location(world, -94.5, 49, -141.5)), 102);
		...
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -94.5, 51, -148.5)), 106);
		Utils.scheduleTask(() -> Actions.turnHead(berserk, -114.5f, 16.2f), 107);
		Utils.scheduleTask(() -> Actions.AOTV(berserk, new Location(world, -91.5, 50, -149.5)), 108);
		Utils.scheduleTask(() -> {
		...
		Utils.scheduleTask(() -> Actions.AOTV(berserk, new Location(world, -80.5, 49, -150.5)), 114);
		Utils.scheduleTask(() -> {
		...
		Utils.scheduleTask(() -> Actions.AOTV(berserk, new Location(world, -81.5, 49, -139.5)), 118);
		Utils.scheduleTask(() -> Actions.turnHead(berserk, -160.2f, -65.2f), 119);
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -78.5, 70.5, -148.5)), 120);
		Utils.scheduleTask(() -> Actions.turnHead(berserk, -136.3f, 28.3f), 121);
		Utils.scheduleTask(() -> Actions.AOTV(berserk, new Location(world, -74.5, 69, -152.5)), 122);
		Utils.scheduleTask(() -> Actions.turnHead(berserk, -95f, 2.8f), 123);
		Utils.scheduleTask(() -> Actions.AOTV(berserk, new Location(world, -41.5, 69, -155.5)), 124);
		...
		Utils.scheduleTask(() -> Actions.throwPearl(berserk), 133);
		Utils.scheduleTask(() -> Actions.turnHead(berserk, -32.0f, -53.5f), 134);
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -33.5, 91, -142.5)), 135);
		Utils.scheduleTask(() -> {
			Actions.turnHead(berserk, 0f, 10f);
			Actions.setFakePlayerHotbarSlot(berserk, 3);
		}, 136);
		Utils.scheduleTask(() -> Actions.superboom(berserk, -35, 92, -141, -33, 96, -140), 137);
		Utils.scheduleTask(() -> Actions.setFakePlayerHotbarSlot(berserk, 1), 138);
		Utils.scheduleTask(() -> Actions.AOTV(berserk, new Location(world, -33.5, 92, -136.5)), 139);
		Utils.scheduleTask(() -> {
			Actions.swingHand(berserk);
			Bukkit.broadcastMessage(ChatColor.RED + "Berserk: Dino Dig Site 1/4 (Opened Chest)");
			world.playSound(berserk.getLocation(), Sound.BLOCK_CHEST_OPEN, 1.0F, 1.0F);
			Actions.AOTV(berserk, new Location(world, -50.059, 68.82469, -151.404));
		}, 140);
		Utils.scheduleTask(() -> Actions.turnHead(berserk, 44f, 65.2f), 141);
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -54.5, 57, -146.5)), 142);
		Utils.scheduleTask(() -> Actions.turnHead(berserk, 0f, 0f), 143);
		Utils.scheduleTask(() -> Actions.AOTV(berserk, new Location(world, -54.5, 57, -144.5)), 144);
		Utils.scheduleTask(() -> {
			Actions.turnHead(berserk, 135.7f, 34.6f);
			Bukkit.broadcastMessage(ChatColor.RED + "Berserk: Dino Dig Site 2/4 (Obtained Item)");
			world.playSound(berserk.getLocation(), Sound.ENTITY_ITEM_PICKUP, 1.0F, 1.0F);
		}, 145);
		Utils.scheduleTask(() -> Actions.AOTV(berserk, new Location(world, -61.5, 50, -151.5)), 146);
		Utils.scheduleTask(() -> Actions.turnHead(berserk, 90f, 40.2f), 147);
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -63.5, 50, -151.5)), 148);
		Utils.scheduleTask(() -> {
			Actions.turnHead(berserk, 180.0f, -6.1f);
			Actions.setFakePlayerHotbarSlot(berserk, 5);
		}, 149);
		Utils.scheduleTask(() -> Actions.stonk(berserk, world.getBlockAt(-64, 51, -156)), 150);
		Utils.scheduleTask(() -> {
			Actions.swingHand(berserk);
		...
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -50.5, 58, -146.5)), 153);
		Utils.scheduleTask(() -> Actions.turnHead(berserk, -111.1f, 19.6f), 154);
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -18.5, 48, -158.5)), 155);
		Utils.scheduleTask(() -> Actions.turnHead(berserk, -10.7f, 10.4f), 156);
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -16.5, 48, -147.5)), 157);
		Utils.scheduleTask(() -> {
			Actions.turnHead(berserk, 0f, 34f);
			Actions.setFakePlayerHotbarSlot(berserk, 0);
		}, 158);
		Utils.scheduleTask(() -> {
			Actions.witherImpact(berserk, new Location(world, -16.5, 47, -143.5));
		...
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -17.5, 48, -157.5)), 161);
		Utils.scheduleTask(() -> Actions.turnHead(berserk, 26.5f, -64.1f), 162);
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -20.5, 62, -152.5)), 163);
		Utils.scheduleTask(() -> Actions.turnHead(berserk, 17.8f, -7.6f), 164);
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -31.5, 69, -119.5)), 165);
		Utils.scheduleTask(() -> Actions.turnHead(berserk, 93.6f, 4.9f), 166);
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -50.5, 69, -120.5)), 167);
		...
		Utils.scheduleTask(() -> Actions.stonk(berserk, world.getBlockAt(-52, 70, -121)), 169);
		Utils.scheduleTask(() -> Actions.stonk(berserk, world.getBlockAt(-53, 70, -121)), 170);
		Utils.scheduleTask(() -> {
			Actions.swingHand(berserk);
		...
		Utils.scheduleTask(() -> Actions.leap(berserk, Tank.get()), 173);
		...
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -218.5, 73, -163.5)), 175);
		Utils.scheduleTask(() -> Actions.turnHead(berserk, -62.9f, 6.5f), 176);
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -207.5, 74, -157.5)), 177);
		Utils.scheduleTask(() -> Actions.turnHead(berserk, -47.1f, -3.5f), 178);
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -195.5, 77, -146.5)), 179);
		Utils.scheduleTask(() -> Actions.turnHead(berserk, 64f, -38.4f), 180);
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -199.5, 83, -144.5)), 181);
		Utils.scheduleTask(() -> {
			Actions.turnHead(berserk, 90f, 23.5f);
			Actions.setFakePlayerHotbarSlot(berserk, 3);
		}, 182);
		Utils.scheduleTask(() -> Actions.superboom(berserk, -206, 83, -146, -205, 86, -144), 183);
		Utils.scheduleTask(() -> {
			Actions.turnHead(berserk, 92.6f, 4.4f);
			Actions.setFakePlayerHotbarSlot(berserk, 1);
		}, 184);
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -220.5, 83, -145.5)), 185);
		...
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -219.5, 84, -146.5)), 189);
		Utils.scheduleTask(() -> {
			Actions.turnHead(berserk, 180f, 35f);
			Actions.setFakePlayerHotbarSlot(berserk, 5);
			Actions.move(berserk, new Vector(0, 0, -1.12242), 5);
		}, 190);
		Utils.scheduleTask(() -> Actions.stonk(berserk, world.getBlockAt(-220, 85, -148)), 191);
		Utils.scheduleTask(() -> Actions.stonk(berserk, world.getBlockAt(-220, 84, -148)), 192);
		Utils.scheduleTask(() -> Actions.stonk(berserk, world.getBlockAt(-220, 85, -149)), 193);
		Utils.scheduleTask(() -> Actions.stonk(berserk, world.getBlockAt(-220, 84, -149)), 194);
		Utils.scheduleTask(() -> {
			Actions.turnHead(berserk, -135f, -38.3f);
			Actions.setFakePlayerHotbarSlot(berserk, 7);
		}, 195);
		Utils.scheduleTask(() -> Actions.throwPearl(berserk), 196);
		Utils.scheduleTask(() -> {
			Actions.turnHead(berserk, -164.3f, -28.6f);
			Actions.setFakePlayerHotbarSlot(berserk, 1);
		}, 197);
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -216.5, 91.5, -161.5)), 198);
		Utils.scheduleTask(() -> Actions.turnHead(berserk, 156.1f, 0.4f), 199);
		Utils.scheduleTask(() -> Actions.AOTV(berserk, new Location(world, -219.5, 92, -167.5)), 200);
		...
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -212.5, 92, -165.5)), 204);
		Utils.scheduleTask(() -> {
			Actions.turnHead(berserk, -90f, 35f);
			Actions.setFakePlayerHotbarSlot(berserk, 5);
			Actions.move(berserk, new Vector(1.12242, 0, 0), 3);
		}, 205);
		Utils.scheduleTask(() -> Actions.stonk(berserk, world.getBlockAt(-212, 93, -166)), 206);
		Utils.scheduleTask(() -> Actions.stonk(berserk, world.getBlockAt(-212, 92, -166)), 207);
		Utils.scheduleTask(() -> {
			Actions.turnHead(berserk, -107.9f, 6.4f);
			Actions.setFakePlayerHotbarSlot(berserk, 1);
		}, 208);
		Utils.scheduleTask(() -> Actions.AOTV(berserk, new Location(world, -204.5, 92, -167.5)), 209);
		Utils.scheduleTask(() -> {
		...
		Utils.scheduleTask(() -> {
			...
			Actions.AOTV(berserk, new Location(world, -208.156, 91, -160.633));
		}, 211);
		Utils.scheduleTask(() -> {
			Bukkit.broadcastMessage(ChatColor.RED + "Berserk: Spider 7/9 (Obtained Item)");
			world.playSound(berserk.getLocation(), Sound.ENTITY_ITEM_PICKUP, 1.0F, 1.0F);
		}, 212);
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -213.5, 83, -161.5)), 213);
		Utils.scheduleTask(() -> Actions.turnHead(berserk, -170.6f, 15.9f), 214);
		Utils.scheduleTask(() -> Actions.etherwarp(berserk, new Location(world, -212.5, 83, -167.5)), 215);
		Utils.scheduleTask(() -> Actions.turnHead(berserk, -90f, 12.6f), 216);
		Utils.scheduleTask(() -> Actions.AOTV(berserk, new Location(world, -207.5, 83, -167.5)), 217);
		Utils.scheduleTask(() -> {
			Actions.swingHand(berserk);
	...
	public static void maxor(boolean doContinue) {
		...
		Utils.scheduleTask(() -> Actions.swapFakePlayerInventorySlots(berserk, 11, 36), 207);
		Utils.scheduleTask(() -> {
			Maxor.pickUpCrystal(berserk);
			Bukkit.broadcastMessage(ChatColor.GOLD + "AsapIcey" + ChatColor.GREEN + " picked up an " + ChatColor.AQUA + "Energy Crystal" + ChatColor.GREEN + "!");
		}, 239);
	...
	private static void goldor(boolean doContinue) {
		...
		Utils.scheduleTask(() -> Actions.setFakePlayerHotbarSlot(berserk, 2), 23);
		Utils.scheduleTask(() -> {
		...
		Utils.scheduleTask(() -> Actions.leap(berserk, Archer.get()), 36);
...
//		Utils.scheduleTask(() -> Actions.move(berserk, new Vector(-1.12225, 0, 0.0196), 2), 27);
//		Utils.scheduleTask(() -> Actions.move(berserk, new Vector(-0.2805, 0, 0.0049), 3), 29);
//		Utils.scheduleTask(() -> {
//			Actions.turnHead(berserk, 72f, 0f);
//			Actions.move(berserk, new Vector(-1.0675, 0, 0.3469), 1);
//			Actions.jump(berserk);
//			Actions.setFakePlayerHotbarSlot(berserk, 1);
//		}, 32);
//		Utils.scheduleTask(() -> Actions.move(berserk, new Vector(-0.2669, 0, 0.0867), 12), 33);
//		Utils.scheduleTask(() -> Actions.turnHead(berserk, 63.5f, 0f), 45);
//		Utils.scheduleTask(() -> Actions.move(berserk, new Vector(-1.0045, 0, 0.501), 2), 46);
//		Utils.scheduleTask(() -> Actions.turnHead(berserk, 63.5f, 82f), 47);
//		Utils.scheduleTask(() -> Actions.simulateBonzo(berserk, new Vector(-1.365, 0.5, 0.6809)), 48);
//		Utils.scheduleTask(() -> Actions.turnHead(berserk, 63.5f, 0f), 49);
//		Utils.scheduleTask(() -> {
...
//		}, 60);
//		Utils.scheduleTask(() -> Actions.turnHead(berserk, 94.5f, 82f), 69);
//		Utils.scheduleTask(() -> Actions.move(berserk, new Vector(-1.119, 0, -0.0881), 1), 70);
//		Utils.scheduleTask(() -> Actions.simulateBonzo(berserk, new Vector(-1.5208, 0.5, -0.1197)), 71);
//		Utils.scheduleTask(() -> Actions.turnHead(berserk, 94.5f, 0f), 72);
//		Utils.scheduleTask(() -> Actions.setFakePlayerHotbarSlot(berserk, 7), 73);
//		Utils.scheduleTask(() -> Actions.simulateLeftClickAir(berserk), 74); // equip phoenix
//		Utils.scheduleTask(() -> Actions.setFakePlayerHotbarSlot(berserk, 5), 75);
//		Utils.scheduleTask(() -> world.playSound(berserk.getLocation(), Sound.ENTITY_GENERIC_EAT, 1f, 1f), 80);
//		Utils.scheduleTask(() -> Actions.turnHead(berserk, 94.5f, 60f), 93);
//		Utils.scheduleTask(() -> Actions.simulateStonking(berserk, world.getBlockAt(18, 114, 44)), 94);
//		Utils.scheduleTask(() -> Actions.turnHead(berserk, 0f, 35f), 95);
//		Utils.scheduleTask(() -> {
//			Actions.move(berserk, new Vector(-0.7937, 0, 0.7937), 1);
//			Actions.simulateStonking(berserk, world.getBlockAt(18, 115, 45));
//		}, 96);
//		Utils.scheduleTask(() ->  {
//			Actions.move(berserk, new Vector(0, 0, 0.8634), 14);
//			Actions.simulateStonking(berserk, world.getBlockAt(18, 114, 45));
//		}, 97);
//		Utils.scheduleTask(() -> Actions.simulateStonking(berserk, world.getBlockAt(18, 115, 46)), 98);
//		Utils.scheduleTask(() -> Actions.simulateStonking(berserk, world.getBlockAt(18, 114, 46)), 99);
//		Utils.scheduleTask(() -> {
//			Actions.simulateStonking(berserk, world.getBlockAt(18, 115, 47));
//			world.playSound(berserk.getLocation(), Sound.ENTITY_GENERIC_EAT, 1f, 1f);
//		}, 100);
//		Utils.scheduleTask(() -> Actions.simulateStonking(berserk, world.getBlockAt(18, 114, 47)), 101);
//		Utils.scheduleTask(() -> Actions.simulateStonking(berserk, world.getBlockAt(18, 115, 48)), 102);
//		Utils.scheduleTask(() -> Actions.simulateStonking(berserk, world.getBlockAt(18, 114, 48)), 103);
//		Utils.scheduleTask(() -> Actions.simulateStonking(berserk, world.getBlockAt(18, 115, 49)), 104);
//		Utils.scheduleTask(() -> Actions.simulateStonking(berserk, world.getBlockAt(18, 114, 49)), 105);
//		Utils.scheduleTask(() -> Actions.simulateStonking(berserk, world.getBlockAt(18, 115, 50)), 106);
//		Utils.scheduleTask(() -> Actions.simulateStonking(berserk, world.getBlockAt(18, 114, 50)), 107);
//		Utils.scheduleTask(() -> Actions.simulateStonking(berserk, world.getBlockAt(18, 115, 51)), 108);
//		Utils.scheduleTask(() -> Actions.simulateStonking(berserk, world.getBlockAt(18, 114, 51)), 109);
//		Utils.scheduleTask(() -> {
//			Actions.turnHead(berserk, -135f, 0f);
//			Actions.setFakePlayerHotbarSlot(berserk, 1);
//		}, 114);
//		Utils.scheduleTask(() -> Actions.simulateBonzo(berserk, new Vector(-1.0787, 0.5, 1.0787)), 115);
//		Utils.scheduleTask(() -> Actions.turnHead(berserk, 45f, 0f), 116);
//		Utils.scheduleTask(() -> {
...
//		}, 120);
//		Utils.scheduleTask(() -> Actions.swapFakePlayerInventorySlots(berserk, 10, 39), 121);
//		Utils.scheduleTask(() -> Actions.setFakePlayerHotbarSlot(berserk, 7), 122);
//		Utils.scheduleTask(() -> Actions.simulateLeftClickAir(berserk), 123); // equip greg
//		Utils.scheduleTask(() -> Actions.setFakePlayerHotbarSlot(berserk, 5), 124);
...
//			Actions.setFakePlayerHotbarSlot(berserk, 1);
//		}, 186);
//		Utils.scheduleTask(() -> Actions.simulateBonzo(berserk, new Vector(0, 0, 1.52552)), 187);
